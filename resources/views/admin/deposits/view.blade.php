                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <h6>Inquiry Due By :     @if(!is_null($ticket->sla)){{\Carbon\Carbon::parse($ticket->updated_at)->addDays($ticket->sla->hours)}} @else<small class="text-danger">Not set</small>@endif</h6>
                                    @endcan
                                </div>
                                <div class="card-body">
                                    <div class="row">
